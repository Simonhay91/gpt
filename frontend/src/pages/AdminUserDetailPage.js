            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  ...
                  История вопросов ({questionHistory.length})
                </CardTitle>
                <CardDescription>
                  Все вопросы пользователя (без ответов AI)
                </CardDescription>
              </CardHeader>
              <CardContent>
                {isLoadingQuestions ? (
                  ...
                  <p className="text-sm text-muted-foreground text-center py-4">Нет вопросов</p>
                ) : (
                  <>
                    <div className="space-y-2 max-h-[400px] overflow-y-auto">
                      {(showAllQuestions ? questionHistory : questionHistory.slice(0, 10)).map((question, idx) => (
                        <div key={idx} className="p-3 bg-secondary/30 rounded-lg border-l-2 border-emerald-500">
                      ...
                      >
                        {showAllQuestions ? (
                          ...
                          <>
                            ...
                            Показать все ({questionHistory.length})
                          </>
                        )}
                      </Button>
                    )}
